...
@swagger_auto_schema(operation_description="This endpoint returns all Weekly Sales", method="GET")
@api_view(['GET'])
...
@swagger_auto_schema(operation_description="This endpoint delete Weekly Sales", method="DELETE")
@api_view(["DELETE"])
